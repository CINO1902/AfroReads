...
class KidsSignInPage extends StatefulWidget {
  const KidsSignInPage({super.key});

  @override
  State<KidsSignInPage> createState() => _KidsSignInPageState();
}

class _KidsSignInPageState extends State<KidsSignInPage> {
  ...
  void handlerequest(AuthPro value) async {
    ...
    await context
        .read<AuthPro>()
        .loginkid(_parentEmailController.text, _parentPasswordController.text);
